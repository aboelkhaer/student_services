...
class DrawerBody extends StatelessWidget {
  final double drawerTextSize = 15.0;
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
...
class AdminAndLib extends StatelessWidget {
  bool _isAdmin;
  bool _isLib;
  Users users = Users();
  @override
  ...
  Widget libFeature(BuildContext context) {
    if (_isLib == true) {
      return Container(
        alignment: Alignment.center,
        // This align moves the children to the bottom
